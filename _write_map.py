...
content = r"""# K.E.R.N.E.L — карта проекта Logogram
...
with io.open("KERNEL_PROJECT_MAP.md", "w", encoding="utf-8") as f:
    f.write(content)

print("written:", os.path.abspath("KERNEL_PROJECT_MAP.md"))
print("size:", os.path.getsize("KERNEL_PROJECT_MAP.md"), "bytes")